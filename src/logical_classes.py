...
class Rule(object):
    ...
    def __repr__(self):
        """Define internal string representation
        """
	#print 'Supports_Rules: ' , self.supports_rules
        #print 'Supports rules:'
	#for x in self.supports_rules:
		#print x
    ...
    def __str__(self):
        """Define external repr1esentation when printed
        """
        string = self.name + ":\n"
        string += "\t Left hand:\n"
...
class Statement(object):
	...
	#traceback.print_stack()
        if statement_list:
	    #print 'Predicate in constructor: '
	    #print type(statement_list[0])
    ...
    def __str__(self):
        """Define external representation when printed
        """
	#print 'Predicate in __str__'
	#print 'Predicate type: ', type(self.predicate)
